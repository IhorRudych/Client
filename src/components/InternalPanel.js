...
module.exports = kind({
    ...
    handlers: {},
    components: [
        {name: 'InternalToolbar', kind: FittableColumns, classes: 'data-toolbar', components: [
            {kind: FittableColumns, classes: 'data-label', components: [
                {name: 'InternalPageLogo', kind: EnyoImage, src: './assets/svg/UI-elements-forSVG_gfx-symbol-svc-light.svg'},
                {content: 'CONFIG'},
            ]},
            { kind: ToolDecorator, classes: 'data-logo nav-icon-group', components: [
                { name: 'InternalDeviceButton', classes: 'btn-icon', kind: DeviceStatus },
                // { name: 'InternalSettingsButton', classes: 'btn-fade btn-icon', kind: IconButton, src: './assets/svg/UI-elements-forSVG_gfx-settings-light.svg' },
            ]},
        ]},
        {name: 'InternalArea', fit: true, classes:'padall', components: [
